...
<div class="main_content_iner ">
    <div class="col-lg-12">
        ...
        <div class="col-md-6">
        <label class="form-label" for="lname">Soyadınız</label>
        <input type="text" name="lname" class="form-control" id="lname" value="{{ Auth::user()->lname }}" placeholder="Soyadınız">
        </div>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="password" name="reset_password" class="form-control" id="newpassword" placeholder="****">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <input type="password" name="confirm_password" class="form-control" id="newpassword1" placeholder="****">
            </div>
            </div>
